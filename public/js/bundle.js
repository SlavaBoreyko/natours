...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2xhdmFzdGFydHVwIiwiYSI6ImNrcXVwODY3ejA2bnkydm82bjhvMmVyNDYifQ.dJEh-EdjMJZzZO7Rna0jGw';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            console.log('Error logging out!', _context2.t0);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              alert("".concat(type.toUpperCase(), " updated successfully!"));
              setTimeout(function () {
                window.location.reload();
              });
            }
...
var stripe = Stripe('pk_test_51JH0cHJhsrpSfP1Pso8J699kJA9BOPilC4dBIGtQ3r1DZP9JNJu53i9OG73TJQoWsXTOYaoAKWSGP2BcBI9L1FvV00ujROgPUe');
...
var previewAvatar = document.querySelector('#previewAvatar'); // const choosePhoto = document.querySelector('#choosePhoto');
// const linkNewPhoto = document.querySelector('#photo');

var filePreview = document.getElementById('photo');
...
if (filePreview) filePreview.addEventListener('change', function () {
  console.log(filePreview.files[0]), previewAvatar.src = URL.createObjectURL(filePreview.files[0]), console.log(previewAvatar.src); // previewAvatar.src = `/img/users/downloadDefault.jpg`
}, false); // PREVIEW-PHOTO
// const input1 = document.querySelector('input');
// filePreview.addEventListener(
//     'change', (filePreview) => { 
//         console.log(linkNewPhoto),
//         previewAvatar.src = window.URL.createObjectURL(input1.files[0])
//     },
//     false
// );
